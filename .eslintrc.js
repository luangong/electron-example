module.exports = {
  ...
  settings: {
    // Treat 'electron' as a core module, otherwise ESLint will complain that 'electron' should be
    // in 'dependencies' rather than 'devDependencies' because we imported 'electorn' in JavaScript.
    //
